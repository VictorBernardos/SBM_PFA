...
//	PIN_Configure(CTRL_PORT,PIN_RST,PIN_FUNC_2,PIN_PINMODE_PULLUP,PIN_PINMODE_NORMAL);
//	PIN_Configure(CTRL_PORT,PIN_A0,PIN_FUNC_2,PIN_PINMODE_PULLUP,PIN_PINMODE_NORMAL);
